...
<div class="note_box_header">
  <p class="note_box_header_typo"><spring:message code="talk.outbox" text="보낸 쪽지함" /></p>
</div>
...
<div class="note_box_body">
  <div class="note_box_side_menu">
    ...
    <a href="/${api}/talk/receive" class="note_box_side_menu_list_sub">
      ...
      <p class="note_box_side_menu_list_sub_typo_title"><spring:message code="talk.inbox" text="받은쪽지함" /></p>
    ...
    <a href="/${api}/talk/send" class="note_box_side_menu_list_sub">
      ...
      <p class="note_box_side_menu_list_sub_typo_title_selected"><spring:message code="talk.sentMsg" text="보낸쪽지함" /></p>
    ...
    <div class="note_box_list_container">
      <div class="note_box_list_data_type_container">
        ...
        <div class="note_box_list_data_type_receiver">
          <p class="note_box_list_data_type_typo"><spring:message code="talk.receiver" text="받는사람" /></p>
        </div>
    ...
    <div class="received_note_body">
      <div class="received_note_button_wrapper">
        <a href="javascript:fnOneDelete();" class="received_note_button_delete">
          <p class="received_note_button_delete_typo"><spring:message code="talk.delete" text="삭제" /></p>
        </a>
...
<!--         </div> -->
      ...
      <div class="received_note_info_container">
        <div class="received_note_info">
          <p class="received_note_info_title"><spring:message code="talk.receiver" text="받는사람" /></p>
