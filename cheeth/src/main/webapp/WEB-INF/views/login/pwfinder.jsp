...
<form:form id="loginForm" name="loginForm" action="/api/login/emailSendAction" method="post">
	<div class="login_body">
	  <div class="login_container">
	    <p class="login_title_typo"><spring:message code="login.findPW" text="비밀번호 찾기" /></p>
	    <div class="login_editor_container">
	      <input type="text" class="login_editor" id="id" name="email" placeholder="<spring:message code="login.enter.email" text="이메일을 입력해주세요." />" />
	    </div>
	    <button type="submit" class="login_submit_button" style="cursor: pointer;" onclick="fnLogin();">
	      <p class="login_submit_button_typo"><spring:message code="find" text="찾기" /></p>
	    </button>
	  </div>
	</div>
</form:form>
