...
<script>
  ...
  function fnScore() {
    ...
    $('.equipment_estimator_my_page_progress_writing_review_star_numb').html(score);
    $('#reviewSaveForm #SCORE').val(score);
  }
  ...
  function fnGetReviewData() {
    var reviewNo = arguments[0];
    $.ajax({
      url: '/' + API + '/review/getData',
      type: 'GET',
      ...
      success: function(data) {
        ...
        $('#reviewSaveForm #REVIEW_NO').val(data.REVIEW_NO);
        $('#reviewSaveForm #REVIEW_CONTENT').val(data.REVIEW_CONTENT);
        
        $('.equipment_estimator_my_page_progress_writing_review_star_numb').html(data.SCORE);
        $('.equipment_estimator_my_page_progress_writing_review_category').html(data.PROJECT_CD_NM);
        
        if(isEmpty(data.FILE_CD)) {
          $('#reviewImg').prop('src', '/public/assets/images/profile_image.svg');
        } else {
          $('#reviewImg').prop('src', '/upload/' + data.FILE_DIRECTORY);
        }
...
<form:form id="reviewSaveForm" name="reviewSaveForm">
  ...
  <input type="hidden" id="SCORE" name="SCORE">
	...
	<div class="modal fade" id="reviewUpdateModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
	  <div class="modal-dialog modal-dialog-centered">
	    <div class="modal-content" style="width: fit-content;">
	      <div class="cad_container">
	        <div class="dialog_header">
	          <p class="dialog_header_typo"><spring:message code="rev.editRev" text="후기 수정" /></p>
	      ...
	      <div class="qna_pic_attatchment_pic_upload_container">
	        ...
	        <div class="qna_pic_attatchment_button_container">
	          ...
	          <a href="javascript:reviewUpdateModal.hide();" class="qna_pic_attatchment_button_white">
